...
$(document).ready(function() {
    ...
    $('.btn1').css('opacity','1').css('width','150px');//첫번째 불켜
    
    $('.gallery .link1').fadeIn('fast'); //첫번째 이미지 보인다..
    $('.gallery .link1 span').delay(1000).animate({top:250, opacity:1},'slow');
    $('.gallery .link1 p').delay(1500).animate({top:360, opacity:1},'slow');
    ...
    //   }
      ...
      $('.mbutton').css('opacity','.5').css('width','30px');//첫번째 불켜
      $('.btn'+cnt).css('opacity','1').css('width','150px');//자신만 불켜

      $('.gallery li span').css('top',200).css('opacity',0);
      $('.gallery li p').css('top',300).css('opacity',0);
      $('.gallery .link'+cnt).find('span').delay(1000).animate({top:250, opacity:1},'slow');
      $('.gallery .link'+cnt).find('p').delay(1500).animate({top:360, opacity:1},'slow');
